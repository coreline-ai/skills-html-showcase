---
name: adaptive-html-learning-ultimate
description: |
  ...
  adaptive-html-blog-writer-v2의 7개 모드 구조와 adaptive-html-learning-ultimate의 라우터/평가 체계를 통합하고,
  현재 blog-demos급 editorial 디자인 시스템을 유지한다.
---
...
이 스킬은 `html-for-beginners` → `adaptive-html-blog-writer` → `adaptive-html-blog-writer-v2` → `adaptive-html-learning-ultimate` 계열을 통합한 최종형 HTML 콘텐츠 제작 스킬이다.
...
- expert: executive summary, decision cards, risk matrix, roadmap, validation
