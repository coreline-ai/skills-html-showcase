...
# http://localhost:8080/skills/adaptive-html-final/examples/index.html</code></pre><pre class="wg-14-code wg-14-code-cli"><code>python3 skills/adaptive-html-final/scripts/validate_output.py \
  output/adaptive-html-final-sequential-16-modes-20260607_105404 \
...
evidence = {
    ...
    'link': 'http://localhost:8080/output/adaptive-html-final-sequential-16-modes-20260607_105404/pages/05_github_analysis_skills_html_showcase_due_diligence.html',
